...
| `run_gradio.bat` | **Запуск единого Gradio-демо.** Веб-интерфейс для всех задач генерации, редактирования и понимания изображений и видео. |
| `run_gradio_image.bat` | *(Устаревший)* Запуск Gradio-демо только для изображений. |
| `run_gradio_video.bat` | *(Устаревший)* Запуск Gradio-демо только для видео. |
...
<details>
<summary><strong>Устаревшие скрипты (раздельные Gradio)</strong></summary>
